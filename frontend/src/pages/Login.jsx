    ...
    <div className='flex justify-center items-center min-h-[90vh] bg-gray-50 sm:px-6 py-10'>
      <div className='w-full max-w-md p-6 bg-white border border-gray-200 shadow-xl sm:p-10 rounded-2xl' >
        <div className='mb-8 text-center'>
          ...
          <h1 className='text-3xl font-black leading-tight text-gray-900 sm:text-4xl'>Welcome <span className='text-teal-500'>Back</span></h1>
        ...
        <p className="mt-8 text-sm text-center text-gray-500">
          New here? <Link to="/register" className="font-bold text-teal-600 hover:underline">Create an account</Link>
        </p>
